...
<solution name="org.campagnelab.workflow.run" uuid="c039a1a6-4680-46fa-b571-a6a5f1e49ab6" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${module}/jsch-0.1.53.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
