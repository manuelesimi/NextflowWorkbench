...
<model ref="r:df8b021b-a7f8-4655-bf02-9abcab9131bf(org.campagnelab.docker.typesystem)">
    ...
    <node concept="Q5ZZ6" id="5uN7hWa36wy" role="Q6x$H">
      <node concept="3clFbS" id="5uN7hWa36wz" role="2VODD2">
        ...
        <node concept="3clFbF" id="5uN7hWa3g5z" role="3cqZAp">
          <node concept="2OqwBi" id="5uN7hWa3g6V" role="3clFbG">
            <node concept="37vLTw" id="5uN7hWa3g5y" role="2Oq$k0">
              <ref role="3cqZAo" node="5uN7hWa3a7r" resolve="part" />
            </node>
            <node concept="2qgKlT" id="1Fq$Xhj5X7E" role="2OqNvi">
              <ref role="37wK5l" to="cb06:1Fq$Xhj5UQv" resolve="clearPart" />
            </node>
          </node>
        </node>
        <node concept="3clFbF" id="5uN7hWa42jL" role="3cqZAp">
          <node concept="2OqwBi" id="5uN7hWa42lg" role="3clFbG">
            <node concept="37vLTw" id="5uN7hWa42jK" role="2Oq$k0">
              <ref role="3cqZAo" node="5uN7hWa3a7r" resolve="part" />
            </node>
            <node concept="2qgKlT" id="1Fq$Xhj5XtO" role="2OqNvi">
              <ref role="37wK5l" to="cb06:1Fq$Xhj5VLH" resolve="setIsDirectory" />
              <node concept="3clFbT" id="1Fq$Xhj5Xxz" role="37wK5m">
  ...
  <node concept="18kY7G" id="73rH4JIl7OK">
    <property role="TrG5h" value="check_Config" />
    <node concept="3clFbS" id="73rH4JIl7OL" role="18ibNy">
      <node concept="3clFbJ" id="73rH4JIl7OR" role="3cqZAp">
        <node concept="3clFbS" id="73rH4JIl7OS" role="3clFbx">
          <node concept="2MkqsV" id="73rH4JIl8hI" role="3cqZAp">
            <node concept="Xl_RD" id="73rH4JIl8i9" role="2MkJ7o">
              <property role="Xl_RC" value="empty name" />
            </node>
            <node concept="1YBJjd" id="73rH4JIl8jh" role="2OEOjV">
              <ref role="1YBMHb" node="73rH4JIl7ON" resolve="config" />
            </node>
          </node>
        </node>
        <node concept="2OqwBi" id="73rH4JIl85b" role="3clFbw">
          <node concept="2OqwBi" id="73rH4JIl7Rk" role="2Oq$k0">
            <node concept="1YBJjd" id="73rH4JIl7Pi" role="2Oq$k0">
              <ref role="1YBMHb" node="73rH4JIl7ON" resolve="config" />
            </node>
            <node concept="3TrcHB" id="73rH4JIl7YO" role="2OqNvi">
              <ref role="3TsBF5" to="tpck:h0TrG11" resolve="name" />
            </node>
          </node>
          <node concept="17RlXB" id="73rH4JIl8h3" role="2OqNvi" />
        </node>
      </node>
    </node>
    <node concept="1YaCAy" id="73rH4JIl7ON" role="1YuTPh">
      <property role="TrG5h" value="config" />
      <ref role="1YaFvo" to="6jv6:7MTH03m4HK1" resolve="Config" />
    </node>
  </node>
</model>
